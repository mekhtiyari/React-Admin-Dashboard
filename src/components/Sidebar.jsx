...
const Sidebar = () => {
  ...
  const activeLink =
    "flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-md m-2 bg-slate-500";
  const normalLink =
          ...
          <div className="flex justify-between items-center">
            ...
            <TooltipComponent content="Menu" position="BottomCenter">
              <button
                ...
                className=" tr text-xl rounded-full p-3 hover:bg-light-gray mt-4 block"
              >
                <MdOutlineCancel />
              </button>
            </TooltipComponent>
